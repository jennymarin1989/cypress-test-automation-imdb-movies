...
describe('IMDB Req_id 1.3, ', () => {
  ...
  it('should be possible to filter photos by person in movie filter', () => {
    ...
    commonElements.findElementAndCheckDisplay(tvShowTitleElement, 'h1', menuOptionValue);
    ...
    commonElements.findElementAndCheckDisplay(movieTitleElement, 'span', 'Breaking Bad');
    ...
    commonElements.findElementAndCheckDisplay('.ipc-page-section', '.ipc-title h1', 'Photos');
